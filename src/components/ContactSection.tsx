...
import { Github, Linkedin, Mail, MapPin, Phone } from "lucide-react"; // Changed back to 'Linkedin'
...
const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const formPayload = {
      access_key: "3453097f-9161-4a50-b4bd-2d9212d9551a", // Your new access key
      ...formData,
    };
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a
                  ...
                  className="bg-muted p-3 rounded-full text-muted-foreground hover:bg-primary hover:text-primary-foreground transition-colors"
                >
                  <Linkedin size={20} /> {/* Changed back to 'Linkedin' */}
                </a>
                <a
                  href={Links.email}
                  target="_blank"
          ...
          <div className="md:col-span-2">
            ...
            >
              <input
                type="hidden"
                name="access_key"
                value="3453097f-9161-4a50-b4bd-2d9212d9551a"
              />
              <input
                type="hidden"
                name="redirect"
