    ...
    >
      ...
      <div className="section-container flex flex-col lg:flex-row items-center justify-between gap-10">
        <div className="flex flex-col max-w-xl space-y-6 text-center lg:text-left">
          ...
          >
            Passionate about building intelligent applications and exploring new technologies.
          </motion.p>
          ...
          <div className="relative">
            ...
            >
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="text-xs text-gray-500">meeth-amin.ts</div>
              </div>

              <div className="space-y-2 font-mono text-sm">
                <div className="text-gray-500">{"// Software Engineer (AI/ML)"}</div>
                <div>
                ...
                >
                  ...
                  <span className="text-gray-500">:</span>{" "}
                  <span className="text-green-600">'Meeth Amin'</span>
                  <span className="text-gray-500">,</span>
                </motion.div>
